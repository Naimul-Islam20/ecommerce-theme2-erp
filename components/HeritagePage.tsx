...
export function HeritagePage({
  ...
  return (
    <>
        ...
        <div className="page-wrap">
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {cards.map((card, index) => (
              <article key={card} className="relative min-h-[230px] rounded-[22px] border border-[#d9dfd1] bg-[#fffdf8] p-[25px] sm:min-h-[270px]">
                <span className="absolute top-[18px] right-5 text-[11px] font-black text-[#a3ada5]">0{index + 1}</span>
                <div className="mb-[35px] grid h-[54px] w-[54px] place-items-center rounded-full bg-green-dark text-[22px] text-white sm:mb-[55px]">◌</div>
                <h3 className="mb-2.5 font-serif text-[22px] text-green-dark">{card}</h3>
      ...
      <section className="bg-[#e9eee6] py-14 sm:py-[78px]">
